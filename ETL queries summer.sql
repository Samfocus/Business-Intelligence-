...
 -- Using trips from 2014 and 2015,
...
  -- We will group trips into 10 minute intervals, which also reduces the number of row
...
INNER JOIN
`planar-granite-404916.Cylistic.zip_codes` AS ZIPSTARTNAME
ON ZIPSTART.zip_code = CAST(ZIPSTARTNAME.zip AS STRING)
INNER JOIN
  `planar-granite-404916.Cylistic.zip_codes` AS ZIPENDNAME
